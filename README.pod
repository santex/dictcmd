...
=item -de2en
=item -de the given word is a german one and you want to search the english equivalent.
=item -en2de
=item -en the given word is a english one and you want to search the german equivalent.
=item -online use only online search 
=item -offline use only offline search in the en-de.ISO-8859-1.vok file
